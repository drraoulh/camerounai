...
export const HF_VOICES: HfVoiceOption[] = [
  ...
  },
  {
    id: "hf:mms-dua",
    source: "hf",
    name: "Sawa · Duala (ton côtier)",
    nameEn: "Sawa · Duala (coastal tone)",
    lang: "dua",
    model: "facebook/mms-tts-dua",
    group: "cameroon",
  },
  {
    id: "hf:mms-ewo",
    source: "hf",
    name: "Fang-Beti · Ewondo",
    nameEn: "Fang-Beti · Ewondo",
    lang: "ewo",
    model: "facebook/mms-tts-ewo",
    group: "cameroon",
  },
  {
    id: "hf:mms-ybb",
    source: "hf",
    name: "Grassfields · Yemba",
    nameEn: "Grassfields · Yemba",
    lang: "ybb",
    model: "facebook/mms-tts-ybb",
    group: "cameroon",
  },
  {
    id: "hf:mms-bbj",
    source: "hf",
    name: "Grassfields · Ghomálá' (ton palais, proche Shüpamom)",
    nameEn: "Grassfields · Ghomala (palace tone, close to Shüpamom)",
    lang: "bbj",
    model: "facebook/mms-tts-bbj",
    group: "cameroon",
  },
  {
